...
write.csv(mydata,"C:/Users/Kate/OneDrive - University of North Carolina at Chapel Hill/2019laptop/Documents/TPC_Acropora/R_files/R_Output/TPC_params/mydata_ln.rate_TPC.csv")#save longged data and transformed Tempr (K)

################################################################-----filter outliers?
################################################################ whne outliers are filtered- there is no diff in pmax but 
################################################################ when present, there is a large difference between
################################################################ M5 and othher gentypes
################################################################ NOT between treatments in Performance,,,
################################################################ 
################################################################ BUT we need to look at eco-phys data as well
...
write.csv(All.CIT,"C:/Users/Kate/OneDrive - University of North Carolina at Chapel Hill/2019laptop/Documents/TPC_Acropora/R_files/R_Output/All.CI.csv")
write.csv(All.fittedT,"C:/Users/Kate/OneDrive - University of North Carolina at Chapel Hill/2019laptop/Documents/TPC_Acropora/R_files/R_Output/All.fitted.csv")
...
TPCall<-ggplot() +
  ...
  theme(legend.position = "none")+
  geom_line(data=All.fittedT, aes(x=(K - 273.15), y=fitted, colour=individual.ID)) +
  theme(legend.position = "none")+
